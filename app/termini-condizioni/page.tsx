        ...
        <section className="py-32 bg-bg px-6">
            <div className="max-w-3xl mx-auto">
                <div className="mb-12">
                    ...
                    <h1 className="font-heading font-bold text-4xl md:text-5xl text-white mb-4">Termini e Condizioni</h1>
                </div>

                <div className="space-y-12 text-text-muted leading-relaxed font-light">
                    <div>
                        <h2 className="text-white font-heading font-semibold text-2xl mb-4">1. Accettazione dei Termini</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-white font-heading font-semibold text-2xl mb-4">2. Proprietà Intellettuale</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-white font-heading font-semibold text-2xl mb-4">3. Uso del Sito</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-white font-heading font-semibold text-2xl mb-4">4. Limitazione di Responsabilità</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-white font-heading font-semibold text-2xl mb-4">5. Modifiche</h2>
                        <p>
