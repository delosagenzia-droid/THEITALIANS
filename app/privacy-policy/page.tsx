        ...
        <section className="py-32 bg-bg px-6">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-12 text-text-muted leading-relaxed font-light">
                    <div>
                        <h2 className="text-white font-display text-2xl mb-4">1. Titolare del Trattamento</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-white font-display text-2xl mb-4">2. Tipologia di Dati Raccolti</h2>
                    ...
                    <div>
                        <h2 className="text-white font-display text-2xl mb-4">3. Finalità del Trattamento</h2>
                    ...
                    <div>
                        <h2 className="text-white font-display text-2xl mb-4">4. Base Giuridica</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-white font-display text-2xl mb-4">5. Conservazione dei Dati</h2>
                        <p>
                    ...
                    <div>
                        <h2 className="text-white font-display text-2xl mb-4">6. Diritti dell'Utente</h2>
                        <p>
